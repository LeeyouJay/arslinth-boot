...
export default {
  ...
  methods: {
    ...mapMutations(['addVisitedView', 'delVisitedView', 'delAllVisitedView', 'delOthersVisitedView','addCachedViews','delCachedViews','delAllCachedViews','delOthersCachedViews']),
    isActive(tag) {
    ...
    handleCloseCtrl(type) {
      ...
      if (type === 'other') {
        if (this.selectedTag) {
          ...
          this.delOthersCachedViews(this.selectedTag)
        }
      }
      this.tagsContLeft = 0
    }
