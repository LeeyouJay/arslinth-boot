...
import static com.archiveboot.common.Constants.MINI_IMG_SUFFIX;
...
public class ThumbnailsUtil {
    ...
    public static List<String> generateThumbnail2Directory(double scale, String pathname, String... files) throws IOException {
        ...
        for (String file : files) {
            list.add(appendSuffix(file, MINI_IMG_SUFFIX));
        }
        return list;
    }
    ...
    public static String generateThumbnail2Directory(String filePath) throws IOException {
        ...
        Thumbnails.of(inputStream)
                .outputQuality(1f).size(550, 700).toFile(appendSuffix(filePath, MINI_IMG_SUFFIX));
        return appendSuffix(filePath, MINI_IMG_SUFFIX);
    }
    ...
    private static void compressRecurse(File[] files, String pathname) throws IOException {
        for (File file : files) {
            ...
            if (file.isDirectory()) {
                ...
                if (!file.getName().contains(MINI_IMG_SUFFIX) && isImage(extension)) {
