...
import com.archiveboot.common.ImageResult;
import lombok.Data;
...
public class SliderImgUtil {
    ...
    */
    ...
    public ImageResult imageResult() throws IOException {
        ...
        ClassPathResource resource = new ClassPathResource("classpath:img/" + index + ".png");
        InputStream inputStream = resource.getStream();
        BufferedImage oriBufferedImage = ImageIO.read(inputStream);
    ...
    //随机获取一个图片文件
    private File getRandomImage() throws IOException {
        File file = ResourceUtils.getFile("classpath:img/");
    ...
    private BufferedImage compressImage(BufferedImage image, int width, int height) throws IOException {
        return ImgUtil.toBufferedImage(ImgUtil.scale(image, width, height));
    }
