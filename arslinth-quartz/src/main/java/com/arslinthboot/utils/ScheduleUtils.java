...
import static com.arslinthboot.common.ScheduleConstants.JOB_WHITELIST_STR;
...
public class ScheduleUtils {
    ...
    private static Class<? extends Job> getQuartzJobClass(SysJob sysJob) {
        ...
        return isConcurrent ? QuartzDisallowConcurrentExecution.class : QuartzJobExecution.class;
    }
    ...
    public static boolean whiteList(String invokeTarget) {
        ...
        if (count > 1) {
            return StrUtil.containsAnyIgnoreCase(invokeTarget, JOB_WHITELIST_STR);
        }
        List<String> split = StrUtil.split(invokeTarget, ".", true, true);
        Object obj = SpringUtils.getBean(split.get(0));
        return StrUtil.containsAnyIgnoreCase(obj.getClass().getPackage().getName(), JOB_WHITELIST_STR);
    }
}
